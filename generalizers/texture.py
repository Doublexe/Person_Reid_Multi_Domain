...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, IN=False, leaky=False):
...
class Generalizer_D(BasicModule):
    ...
    def _make_layer(self, block, planes, blocks, stride=1,IN=False):
        ...
        layers = []
        layers.append(block(self.inplanes, planes, stride, downsample, leaky=True))
        self.inplanes = planes * block.expansion
        for i in range(1, blocks-1):
